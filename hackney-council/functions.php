...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('hackney-wordpress', get_template_directory_uri() . '/dist/hackney-wordpress.min.js', array(), '1.0.3', true); // Custom scripts
...
{
    wp_register_style('hackney-wordpress', get_template_directory_uri() . '/dist/all.css', array(), '2.1', 'all');
