...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('hackney-wordpress', get_template_directory_uri() . '/dist/hackney-wordpress.min.js', '1.0.0'); // Custom scripts
...
function html5blank_styles()
{
    ...
    wp_register_style('hackney-wordpress', get_template_directory_uri() . '/dist/all.css', array(), '1.0', 'all');
