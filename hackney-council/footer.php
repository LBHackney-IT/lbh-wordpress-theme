					...
					<?php foreach(['footer_links_left', 'footer_links_middle', 'footer_links_right'] as $links): ?>
						<div class="lbh-footer__links-group">
							<?php if (have_rows($links, 'option')): ?>
								...
								<?php endwhile; ?>
							<?php endif; ?>
							<?php if ($links === 'footer_links_right' && get_field('footer_social_links', 'option')): ?>
								<div class="lbh-footer__links-social">
									<?php while(have_rows('footer_social_links', 'option')): the_row(); ?>
										<li class="lbh-footer__social-item">
											<?php if (get_sub_field('type') === 'twitter') : ?>
												<a href="https://twitter.com/<?php the_sub_field('username'); ?>" class="lbh-footer__social-link">
											...
											<?php elseif (get_sub_field('type') === 'facebook') : ?>
												<a href="https://www.facebook.com/<?php the_sub_field('username'); ?>" class="lbh-footer__social-link">
											...
											<?php elseif (get_sub_field('type') === 'youtube') : ?>
												<a href="https://www.youtube.com/user/<?php the_sub_field('username'); ?>" class="lbh-footer__social-link">
											...
											<?php elseif (get_sub_field('type') === 'instagram') : ?>
												<a href="https://www.instagram.com/<?php the_sub_field('username'); ?>/" class="lbh-footer__social-link">
